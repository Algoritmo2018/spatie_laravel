                ...
                <div class="p-6 text-gray-900">
                    <form action="{{ route('articles.store') }}" method="post">
                        ...
                        <div>
                            ...
                            <div class="my-3">
                             <textarea name="text" id="text" placeholder="Content" class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full" cols="30" rows="10">{{ old('text') }}</textarea>
                            </div>
                            <label for="" class="text-lg font-medium">Author</label>
                            <div class="my-3">
                                <input value="{{ old('author') }}" name="author" placeholder="Enter author"
                                    type="text"
                                    class="border-gray-300 focus:border-indigo-500 focus:ring-indigo-500 rounded-md shadow-sm w-full">
                                @error('author')
                                    <p class="text-sm text-red-600 space-y-1">{{ $message }}</p>
